...
<body>
	<form action="<%=ORSView.CHANGE_PASSWORD_CTL%>" method="post">
		...
		request.getParameter("oldPassword") == null ? "" : DataUtility.getString(request.getParameter("oldPassword")))%>></td>
				...
				<tr>
					...
					<td align="center"><input type="password" name="newPassword"
						...
						value=<%=DataUtility.getString(
		request.getParameter("newPassword") == null ? "" : DataUtility.getString(request.getParameter("newPassword")))%>></td>
